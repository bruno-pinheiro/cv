...
jobs <- tribble(
  ...
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Responsável pelo modelo de behaviour score',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Responsável pelo monitoramento da cobrança',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Contribuição na modelagem de Expected Loss - EAD, PD, LGD e EL',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Capacitações internas sobre programação e análise de dados em Python',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Desenvolvimento e deploy do modelo de behaviour score',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Participção no desenvolvimento do modelo de credit score',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Clusterização dos contratos em cobrança',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Desenvolvimento do primeiro motor de crédito',
  'Data Scientist, Credit Modeling', 'Stone Co', 'São Paulo/SP', 'Out/19', 'Atual', 'Criação e automatização de rotinas de dados em ambiente AWS',
